<section class="header-section">
    <header class="header">
        <span class="header-intro-text small-text">
            Welcome to
        </span>
        <a href="/" class="header-logo-link no-paywall">
            <img src="<?php echo esc_url( get_template_directory_uri() ); ?>/img/GCC_LogoFull.svg" class="header-logo" alt="Global Creator's Community" />
        </a>
